...
<p>
	...
	<BR> <a href="tutorial/screenshots/addSlotToShiftHelp_shift_view.png"
		...
		rel="popover" data-img="tutorial/screenshots/addSlotToShiftHelp_shift_view.png"
		width="10%" border="1px" align="center">
	</a>
<p>
	<B>Step 3:</B> Click on the <B>Add slot</B> button in the top row of
	the table, like this:<BR>
	<BR> <a href="tutorial/screenshots/addSlotToShiftHelp_add_slot.png"
		...
		rel="popover" data-img="tutorial/screenshots/addSlotToShiftHelp_add_slot.png"
		border="1px" align="center">
	</a>
<p>
	<B>Step 4:</B> A new vacant slot is added to the shift and appears as a
	new row. You can then assign a volunteer to this new slot.<BR>
	<BR> <a
		...
		rel="popover" data-img="tutorial/screenshots/addSlotToShiftHelp_new_volunteer.png"
		width="10%" border="1px" align="center">
	</a>
<p>
	<B>Step 5:</B> To remove a vacant slot from a shift, click on the <b>Ignore
		Vacancy</b> button to the right of that slot, like this.<BR>
	<BR> <a
		...
		rel="popover" data-img="tutorial/screenshots/addSlotToShiftHelp_remove_vacancy.png"
		width="10%" border="1px" align="center">
	</a> <br>Note: you cannot remove a slot that is not vacant without
	first removing the person from the slot.
<p>
