...
<p>
	...
	this:<BR>
	<BR> <a href="tutorial/screenshots/assignToShiftHelp_vacant_shift.png"
		...
		rel="popover" data-img="tutorial/screenshots/assignToShiftHelp_vacant_shift.png"
...
<p>
	...
	<BR> <a href="tutorial/screenshots/assignToShiftHelp_shift_view.png"
		...
		rel="popover" data-img="tutorial/screenshots/assignToShiftHelp_shift_view.png"
		width="10%" border="1px" align="center">
	</a>
<p>
	<B>Step 3:</B> Click on the <B>Assign Volunteer</B> button in the right
	hand column of a <B>vacant</B> row, like this:<BR>
	<BR> <a
		...
		rel="popover" data-img="tutorial/screenshots/assignToShiftHelp_assign_volunteer.png"
		width="10%" border="1px" align="center">
	</a> <BR>
	<br>&nbsp&nbsp&nbsp NOTE: If there is no <B>vacant</B> row, then that
	shift has no vacancies to be filled.<BR>
	<BR>
<p>
	<B>Step 4:</B> You can now view the list of volunteers who are
	available for that shift, like this:<BR>
	<BR> <a
		...
		rel="popover" data-img="tutorial/screenshots/assignToShiftHelp_volunteer_selection.png"
		width="10%" border="1px" align="middle">
	</a> <br>
	<br> (Alternatively, you can view the entire list of volunteers,
	whether or not they are available for that shift.)
<p>
	<B>Step 5:</B> Select the volunteer you want to assign to this shift,
	and then click <B>Add Volunteer</B>, like this:<BR>
	<BR> <a
		...
		rel="popover" data-img="tutorial/screenshots/assignToShiftHelp_volunteer_chosen.png"
		width="10%" border="1px" align="middle">
	</a>
<p>
