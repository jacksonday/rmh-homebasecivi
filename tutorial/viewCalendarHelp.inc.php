...
<p>
	...
	and select <B>view</B>, like this:<BR>
	<BR> <a href="tutorial/screenshots/viewcalendarstep1.gif" class="image"
...
<p>
	...
	here, like this:<BR>
	<BR> <a href="tutorial/screenshots/viewcalendarstep2.gif" class="image"
	...
	</a> <BR> &nbsp&nbsp&nbsp NOTE: this page only lets you view the
	information; it does not allow editing. If you wish to edit the
	calendar, find <B>calendar:</B> and select <B>manage</B>.<BR>
	<BR>
<p>
	...
	<BR> <a href="tutorial/screenshots/viewcalendarstep3.gif" class="image"
