...
<body>
	<div align="left">
		...
		<p>
			<B>Step 4:</B> You will now see a page that lists everyone available
		...
		<p>
			<B>Step 5:</B> When you call a person to find out if they can fill
		...
		<p>
			<B>Step 8:</B> You can return to the shift, the calendar, or any
			other function by selecting it on the navigation bar. <br> <br> <br>
			<br>
		...
		<p>
			<B>Step 1:</B> Click on a calendar shift, like this:<BR> <BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addSlotToShiftHelp_choose_shift.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addSlotToShiftHelp_choose_shift.png"
				border="1px" align="center"> </a> <br> <br> (Each
			upcoming calendar shift will turn gray whenever the mouse passes over
			it.)
		...
		<p>
			...
			<BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addPersonToShiftHelp_initial_view.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_initial_view.png"
				border="1px" align="center"> </a>
		...
		<p>
			...
			like this: <BR> <BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addPersonToShiftHelp_removing_volunteer.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_removing_volunteer.png"
		...
		<p>
			...
			<BR> <BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addPersonToShiftHelp_assign_volunteer.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_assign_volunteer.png" 
			...
			volunteer: <br> <br> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addPersonToShiftHelp_add_view.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_add_view.png"
			...
			contains every volunteer. Once you've chosen a volunteer, click the <b>Add
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/addPersonToShiftHelp_add_view_volunteer.png" width="10%" 
				rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_add_view_volunteer.png"
				border="1px" align="center"> </a> <br> <br> This brings
			you back to the shift form (Step 2), and the selected volunteer will
		...
		<p>
			...
			notes for that shift. <BR> <BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/calendarNotesHelp_note_slots.png" width="10%" 
		...
		<p>
			...
			marked "manager notes".<BR> <BR> <a
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/calendarNotesHelp_manager_notes.png" width="10%" 
		...
		<p>
			...
			bottom of the calendar and click the button <strong>Save changes to
				...
				&nbsp&nbsp&nbsp&nbsp<img
				src="tutorial/screenshots/calendarNotesHelp_save_notes.png" width="10%" 
		...
		<p>
			<B>Step 4:</B> You can return to any other function by selecting it
