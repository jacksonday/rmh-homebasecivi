...
<p>
	...
	calendar page, like this:<BR> <BR> <a
		href="tutorial/screenshots/managecal1.png" class="image"
		title="managecal1.png" target="tutorial/screenshots/managecal1.png"> <img
		src="tutorial/screenshots/managecal1.png" width="10%" border="1px"> </a>
</p>
<p>
	You should then see this page: <a
		href="tutorial/screenshots/managecal2.png" class="image"
		title="managecal2.png" target="tutorial/screenshots/managecal2.png">
		&nbsp&nbsp&nbsp&nbsp<img src="tutorial/screenshots/managecal2.png"
...
<p>
	...
	<i>very first</i> week on your calendar.
<p>
	For example, the above selections show that you chose the week with
	September 28, 2008 to be the first scheduled calendar week, and it
	should be populated with volunteers from Weekday Group 1, Weekend Group
	1, and Family Room Group 1 from the Master Schedule. When you hit <b>submit</b>,
	the first week of your calendar will be populated and the following
	1-row table will appear:
<p>
...
<p>
	<a href="tutorial/screenshots/managecal5.png" class="image"
...
<p>
	...
	in the lower right corner of this table allows you to either see or
	remove the archived weeks from the table.
<p>
	<B>Step 3:</B> You can now choose to <b>reset</b>, <b>view</b>, <b>edit</b>,
	<b>publish</b>, or <b>remove</b> this week from the calendar using the
	buttons on the right.<br> <br>&nbsp&nbsp&nbsp The <b>reset</b> button
	repopulates all the shifts in that week to their original settings from
	the master schedule. <br>&nbsp&nbsp&nbsp The <b>view</b> button takes
	you to the calendar where you can view all the shift assignments for
	that week. <br>&nbsp&nbsp&nbsp The <b>edit</b> button takes you to the
	calendar where you can edit individual shifts for that week. <br>&nbsp&nbsp&nbsp
	The <b>publish/unpublish</b> button controls whether the week is
	visible and editable by any volunteer who is working at the front desk.
	<br>&nbsp&nbsp&nbsp The <b>remove</b> button removes the most recent
	unpublished week from the calendar. (This is rarely used, but will be
	handy when you want to regenerate and repopulate a new week using
	different groups from the Master Schedule.)
<p>For example, here is what you see when you unpublish a published week
	on the calendar:
<p>
