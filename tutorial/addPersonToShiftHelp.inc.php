...
<p>
	<B>Step 1:</B> Click on a calendar shift, like this:<BR>
	<BR> <a href="tutorial/screenshots/addSlotToShiftHelp_choose_shift.png"
...
<p>
	...
	<br> Click that <b>Remove Person</b> button to remove that volunteer
	from that shift's slot, leaving an empty slot.
<p>
	...
	<br> Click the <b>Assign Volunteer</b> button to come to a page where
	you can choose a new volunteer: <br>
	<br>
	<a href="tutorial/screenshots/addPersonToShiftHelp_add_view.png"
	...
	<br> Select a Volunteer using the drop down lists. The first list
	contains volunteers who have listed that time as available, the second
	list contains every volunteer. Once you've chosen a volunteer, click
	the <b>Add Volunteer</b> button: <br>
	<br>
	<a
		...
		rel="popover" data-img="tutorial/screenshots/addPersonToShiftHelp_view_volunteer.png"
		width="10%" border="1px" align="center">
	</a> <br>
	<br> This brings you back to the shift form (Step 2), and the selected
	volunteer will be displayed. <br>
	<br>You can return to any other function by selecting it on the
	navigation bar.