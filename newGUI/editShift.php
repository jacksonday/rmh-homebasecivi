                ...
                if ($shiftid == "") {
                    ...
                    if (!$shift instanceof Shift)
                        ...
                        if (!process_fill_vacancy($_POST, $shift, $venue) &&
                            ...
                            echo "<br><br><table align=\"center\"><tr><td align=\"center\" colspan=\"2\"><b>"
                            ...
                            if ($_SESSION['access_level'] >= 2) {
                                ...
                                echo ("<form method=\"POST\" style=\"margin-bottom:0;\">
											...
											<input type=\"submit\" value=\"Add Slot\" style=\"width: 250px\"
											name=\"submit\" >
											</form>");
                                echo ("<form method=\"POST\" style=\"margin-bottom:0;\">
											<input type=\"hidden\" name=\"_submit_clear_shift\" value=\"1\">
											<input type=\"submit\" value=\"Clear Entire Shift\" style=\"width: 250px\"
											name=\"submit\" >
											</form>");
                                echo ("<form method=\"POST\" style=\"margin-bottom:0;\">
											<input type=\"hidden\" name=\"_submit_move_shift\" value=\"1\">
											<input type=\"submit\" value=\"Move Shift\" style=\"width: 250px\"
											name=\"submit\" >
											</form>");
                                echo "<br></td></tr>";
                            }
                            ...
                            echo "<tr><td colspan=\"2\" align=\"center\">
									&nbsp;<a href=\"calendar.php?id=" . substr($shiftid, 0, 8) . "&edit=true&venue=" . $venue . "\">
									Back to Calendar</a></td></tr></table>";
                        }
                    }
                }
                ?>
